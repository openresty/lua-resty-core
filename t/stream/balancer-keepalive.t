...
--- stream_config
    upstream backend {
        ...
        balancer_by_lua_block {
            ...
            local pok, perr = pcall(b.set_current_peer, "127.0.0.3", 12345, {})
            if not pok then
...
--- stream_server_config
    proxy_pass backend;
--- error_log eval
qr/balancer_by_lua:\d+: bad argument #3 to 'set_current_peer' \('opts' not yet implemented in stream subsystem\)/
