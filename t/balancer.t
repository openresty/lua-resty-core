...
=== TEST 8: set current peer (port embedded in addr)
--- http_config
    lua_package_path "$TEST_NGINX_CWD/lib/?.lua;;";
...
=== TEST 9: keepalive before balancer
--- http_config
    lua_package_path "$TEST_NGINX_CWD/lib/?.lua;;";
...
=== TEST 10: keepalive after balancer
--- http_config
    lua_package_path "$TEST_NGINX_CWD/lib/?.lua;;";
...
=== TEST 11: set_current_peer called in a wrong context
--- wait: 0.2
--- http_config
    lua_package_path "$TEST_NGINX_CWD/lib/?.lua;;";
...
=== TEST 12: get_last_failure called in a wrong context
--- wait: 0.2
--- http_config
    lua_package_path "$TEST_NGINX_CWD/lib/?.lua;;";
...
=== TEST 13: set_more_tries called in a wrong context
--- wait: 0.2
--- http_config
    lua_package_path "$TEST_NGINX_CWD/lib/?.lua;;";
...
=== TEST 14: test ngx.var.upstream_addr after using more than one set_current_peer
--- wait: 0.2
--- http_config
    lua_package_path "$TEST_NGINX_CWD/lib/?.lua;;";
